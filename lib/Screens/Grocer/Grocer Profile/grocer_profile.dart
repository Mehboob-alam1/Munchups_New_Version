...
class GrocerProfilePage extends StatelessWidget {
  ...
  final dummyUserData = {
    ...
    "all_post": [
      {
        "dish_name": "Organic Apples",
        "dish_price": "3.50",
        "dish_description": "Fresh apples from the valley.",
        "dish_images": [
          {"kitchen_image": ""}
        ]
      },
      {
        "dish_name": "Brown Bread",
        "dish_price": "2.00",
        "dish_description": "Whole grain healthy bread.",
        "dish_images": [
          {"kitchen_image": ""}
        ]
      },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            userImage(context, profile),
            const SizedBox(height: 20),
            Text("${profile['first_name']} ${profile['last_name']}", style: white21w5),
            const SizedBox(height: 5),
            Text("Share Point: ${profile['shop_name']}", style: lightWhite14Bold),
            const SizedBox(height: 20),
            Align(alignment: Alignment.centerLeft, child: Text('Recent Post', style: white17Bold)),
            const Divider(color: DynamicColor.white),
            // postList(context, profile['all_post']),
          ],
        ),
      ),
    );
  ...
  Widget userImage(BuildContext context, dynamic profile) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text('${profile['post_count']} Posts', style: white15bold),
        ClipRRect(
          borderRadius: BorderRadius.circular(100),
          child: CircleAvatar(
            radius: 50,
        ...
        Text('${profile['followers']} Followers', style: white15bold),
      ],
    );
  }

  Widget postList(BuildContext context, List posts) {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 10),
                Text(post['dish_name'], style: white14w5),
                Text("\$${post['dish_price']}", style: greenColor15bold),
                const SizedBox(height: 10),
                Text(
