...
// This is the frontend-only version of the GrocerHomePage
...
class _GrocerHomePageState extends State<GrocerHomePage> {
  ...
  List dishList = []; // Dummy frontend data can be used here
  List searchList = [];

  @override
  void initState() {
    super.initState();
    // Mock dummy dish list
    dishList = [
      {
        'dish_name': 'Fresh Salad',
        'dish_price': '9.99',
        'dish_images': [
          {'kitchen_image': 'https://via.placeholder.com/150'}
        ]
      },
      {
        'dish_name': 'Spicy Curry',
        'dish_price': '12.49',
        'dish_images': [
          {'kitchen_image': 'https://via.placeholder.com/150'}
        ]
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            backgroundColor: Colors.transparent,
            elevation: 0,
            leading: Icon(Icons.menu, color: DynamicColor.white, size: 35),
            title: Text(TextStrings.textKey['home']!, style: primary25bold),
            centerTitle: true,
            bottom: PreferredSize(
              preferredSize: const Size.fromHeight(10),
  ...
  Widget serchBox() {
    return InputFieldsWithLightWhiteColor(
        ...
        style: black15bold,
        onChanged: (value) {
          final queryString = value.toLowerCase();
          setState(() {
            searchList = dishList
  ...
  Widget grocerItemList() {
    final listToShow =
    textEditingController.text.isEmpty ? dishList : searchList;
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          final dishData = listToShow[index];
                  ...
                  child: Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(100),
                        child: CustomNetworkImage(
                            url: dishData['dish_images'][0]['kitchen_image']),
                      ),
                    ),
                  ),
                ),
