...
class _PostedDemandFoodPageState extends State<PostedDemandFoodPage> {
  // Dummy frontend data
  final List<Map<String, dynamic>> dummyFoodList = [
    {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final data = dummyFoodList[index];
            return Card(
              elevation: 10,
              color: DynamicColor.boxColor,
              shape: RoundedRectangleBorder(
                      ...
                      Expanded(
                          ...
                          child: ListTile(
                            ...
                            contentPadding: const EdgeInsets.only(
                                left: 5, right: 5, top: 8),
                            minVerticalPadding: 0.0,
                            title: Text(data['occasionCategoryName'],
                                style: white17Bold,
                                maxLines: 1,
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Icon(Icons.draw,
                                  size: 22, color: DynamicColor.white),
                              const SizedBox(width: 10),
                              Icon(Icons.delete,
                                  size: 22, color: DynamicColor.redColor),
                            ],
                          ),
                          const SizedBox(height: 10),
                          CircleAvatar(
