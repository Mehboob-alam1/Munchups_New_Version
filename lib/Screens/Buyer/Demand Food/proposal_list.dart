...
class _ProposalFoodListPageState extends State<ProposalFoodListPage> {
  final List<Map<String, String>> mockProposals = [
    {
      "firstName": "John",
      "lastName": "Doe",
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final data = mockProposals[index];

            return InkWell(
              onTap: () {
                // TODO: Handle card tap if needed
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('Tapped on ${data["firstName"]}')),
                );
              },
              child: Card(
                color: DynamicColor.boxColor,
