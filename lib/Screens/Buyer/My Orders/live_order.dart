...
//
// class LiveOrderList extends StatefulWidget {
//   const LiveOrderList({super.key});
//
//   @override
//   State<LiveOrderList> createState() => _LiveOrderListState();
// }
//
// class _LiveOrderListState extends State<LiveOrderList> {
//   @override
...
class LiveOrderList extends StatelessWidget {
  const LiveOrderList({super.key});

  // Mock order data
  final List<Map<String, dynamic>> mockActiveOrders = const [
    {
      'first_name': 'Alice',
      'last_name': 'Taylor',
      'order_unique_number': 'ORD987654',
      'order_status': 'active',
      'budget': '32.00',
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        final data = mockActiveOrders[index];
