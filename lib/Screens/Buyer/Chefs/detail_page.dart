...
class _DetailPageState extends State<DetailPage> {
  ...
  void initState() {
    ...
    countPrice = double.parse(dishData['dish_price']);
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(dishData['dish_name'], style: white21bold),
                        Text('\$${dishData['dish_price']}',
                            style: const TextStyle(
                                color: DynamicColor.green,
                                fontSize: 18,
                                fontWeight: FontWeight.bold)),
      ...
      child: Row(
        ...
        children: [
          InkWell(
            ...
            child: const Icon(Icons.remove, color: DynamicColor.white),
          ),
          const SizedBox(width: 10),
          Text(count.toString(), style: white17Bold),
          const SizedBox(width: 10),
          InkWell(
            onTap: () {
              setState(() {
            ...
            child: const Icon(Icons.add, color: DynamicColor.white),
          ),
        ],
      ),
    );
  ...
  Widget addToCartButton() {
    return Padding(
      ...
      child: FloatingActionButton.extended(
        ...
        onPressed: () {
          // This is only a frontend mock. No backend logic here.
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text('This is a demo. Item not actually added to cart.'),
          ));
        },
      ),
    );
  ...
  Widget serviceTypeAndPerson() {
    return Column(
      children: [
        ...
        Row(
          children: [
            _infoCard('Meal', dishData['meal'].toString().toUpperCase()),
            _infoCard('Service Type',
                dishData['service_type'].toString().toUpperCase()),
            _infoCard('Portion Per Person', dishData['portion'].toString()),
          ],
        ),
      ],
    );
        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text(title, style: lightWhite14Bold, textAlign: TextAlign.center),
                const SizedBox(height: 5),
                Text(value, style: primary15w5),
              ],
            ),
          ),
        ),
