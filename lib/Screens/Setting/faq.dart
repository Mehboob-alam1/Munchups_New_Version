...
class _FAQPageState extends State<FAQPage> {
  final List<Map<String, String>> faqList = [
    {
      'question': 'What is Munchups?',
      'answer': 'Munchups is a platform connecting food lovers with chefs and grocers.'
    },
    {
      'question': 'How do I register?',
      'answer': 'Download the app and sign up using your email or social account.'
    },
    {
      'question': 'Can I order food as a guest?',
      'answer': 'No, you must register to place an order.'
    },
    {
      'question': 'How do I become a chef?',
      'answer': 'Go to the registration page and select the "Chef" option.'
    },
    {
      'question': 'Is delivery available in all cities?',
      'answer': 'Currently, we deliver in select cities. Check availability during checkout.'
    },
    {
    ...
    },
    {
      ...
      'answer': 'Visit the Help section or email us at support@munchups.com.'
    },
  ];
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        padding: EdgeInsets.symmetric(
          ...
          vertical: SizeConfig.getSize20(context: context),
        ),
        child: Column(
  ...
  Widget customWidget({
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Text('Q$number: ', style: white15bold),
            Expanded(
              child: Text(
                question,
                style: const TextStyle(
