...
class _ChefFollowersListState extends State<ChefFollowersList> {
  final List<Map<String, String>> mockFollowers = [
    {
      'firstName': 'Alice',
      'lastName': 'Smith',
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final follower = mockFollowers[index];
            return InkWell(
              onTap: () {
                showDialog(
                  context: context,
                  barrierDismissible: !Platform.isAndroid,
                  builder: (context) => ChefFollowerProfilePopup(
                    data: {
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 5),
                          // Optionally add phone/location here
                        ],
                      ),
                    ],
                  ),
