...
class ChefCompletedBulkOrderList extends StatefulWidget {
  ...
  @override
  State<ChefCompletedBulkOrderList> createState() => _ChefCompletedBulkOrderListState();
}

class _ChefCompletedBulkOrderListState extends State<ChefCompletedBulkOrderList> {
  // Static dummy order data
  final List<Map<String, dynamic>> completedOrders = [
    {
      "first_name": "Amit",
      "last_name": "Verma",
      "order_unique_number": "ORD2001",
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final data = completedOrders[index];
