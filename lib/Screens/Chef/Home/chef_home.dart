...
class _ChefHomePageState extends State<ChefHomePage> {
  final GlobalKey<ScaffoldState> globalKey = GlobalKey();
  final ValueNotifier<int> notificationCount = ValueNotifier(3); // Simulated count
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          leading: InkWell(
            ...
            child: const Icon(Icons.menu, color: DynamicColor.white, size: 35),
          ),
          title: Text(TextStrings.textKey['home']!, style: primary25bold),
          centerTitle: true,
          actions: [
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: const Icon(Icons.notifications, color: DynamicColor.white, size: 35),
                      ),
                    ),
                    if (count > 0)
                      Padding(
                        ...
                        child: CircleAvatar(
                          radius: 12,
                          backgroundColor: Colors.red,
                          child: Text(count.toString(), style: white14w5),
                        ),
                      )
                  ],
                );
      ...
      body:  ChefsPostedListPage(
        list: [], // Use a simulated or static list here if needed
      ),
    );
  }
