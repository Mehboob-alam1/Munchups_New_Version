...
class _LoginPageState extends State<LoginPage> {
          ...
          child: Form(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  SizedBox(height: SizeConfig.getSize55(context: context)),
                  Image.asset(appLogoUrl, height: 200),
                  SizedBox(height: SizeConfig.getSize40(context: context)),
                  emailField(),
                  SizedBox(height: SizeConfig.getSize25(context: context)),
                  passwordField(),
      ...
      children: [
        Row(
          children: [
            ...
            Text(TextStrings.textKey['remember']!, style: white14w5),
          ],
        ),
        TextButton(
          onPressed: () {
  ...
  Widget termsAndConditions() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Text(TextStrings.textKey['policy']!, style: primary15boldWithUnderline),
        Text(' & ', style: white14w5),
        Text(TextStrings.textKey['terms&con']!,
            style: primary15boldWithUnderline),
      ],
    );
  }
